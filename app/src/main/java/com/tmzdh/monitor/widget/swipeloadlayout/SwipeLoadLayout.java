...
public class SwipeLoadLayout extends ViewGroup {
    ...
    public SwipeLoadLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context
                .obtainStyledAttributes(attrs, R.styleable.SwipeLoadLayout, defStyleAttr, 0);
        try {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == R.styleable.SwipeLoadLayout_refresh_enabled) {
                    ...
                    setLoadMoreTriggerOffset(a.getDimensionPixelOffset(attr, 0));
                        ...
                        R.styleable.SwipeLoadLayout_swiping_to_refresh_to_default_scrolling_duration) {
                    setSwipingToRefreshToDefaultScrollingDuration(a.getInt(attr,
                            DEFAULT_SWIPING_TO_REFRESH_TO_DEFAULT_SCROLLING_DURATION));

                } else if (attr ==
                        R.styleable.SwipeLoadLayout_release_to_refreshing_scrolling_duration) {
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new SwipeLoadLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        if (mFooterView != null) {
            ...
            switch (mStyle) {
                case STYLE.CLASSIC:
                    // classic
                    footerBottom =
                            height - paddingBottom - lp.bottomMargin + mFooterHeight +
                                    mFooterOffset;
                    break;
                case STYLE.ABOVE:
                    // classic
    ...
    private void scrollDefaultToRefreshing() {
        mAutoScroller.autoScroll((int) (mRefreshTriggerOffset + 18.5f),
